...
def main():
    ...
    parser.add_argument('--server_ema_enabled', type=int, default=0,
                        help='Enable server-side EMA over aggregated global parameters.')
    parser.add_argument('--server_ema_decay', type=float, default=0.99,
                        help='EMA decay for server-side global parameter smoothing.')
    ...
    assert args.server_ema_enabled in [0, 1]
    assert 0.0 <= args.server_ema_decay < 1.0
