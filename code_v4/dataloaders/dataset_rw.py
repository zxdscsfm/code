...
def pseudo_label_generator_acdc(data, seed, beta=50, mode='bf', img_class='odoc'):
...
class BaseDataSets(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.split == "train":
            image = h5f['image'][:]
            # print(image.shape)
            if self.img_class == "odoc":
                if "Domain1" in case:
                    label = pseudo_label_generator_acdc(image, h5f["scribble"][:], img_class=self.img_class)
                elif "Domain2" in case:
                    label = pseudo_label_generator_acdc(image, h5f["scribble_noisy"][:], img_class=self.img_class)
                elif "Domain3" in case:
                    label = pseudo_label_generator_acdc(image, h5f["scribble_noisy"][:], img_class=self.img_class)
                elif "Domain4" in case:
                    label = pseudo_label_generator_acdc(image, h5f["keypoint"][:], img_class=self.img_class)
                elif "Domain5" in case:
                    label = pseudo_label_generator_acdc(image, h5f["block"][:], img_class=self.img_class)
            elif self.img_class == 'faz' :
                if "Domain1" in case:
                    label = pseudo_label_generator_acdc(image, h5f["scribble_noisy"][:], img_class=self.img_class)
                elif "Domain2" in case:
                    label = pseudo_label_generator_acdc(image, h5f["keypoint"][:], img_class=self.img_class)
                    ...
                    label = pseudo_label_generator_acdc(image, h5f["box"][:], img_class=self.img_class)
                elif "Domain5" in case:
                    label = pseudo_label_generator_acdc(image, h5f["scribble"][:], img_class=self.img_class)
            elif self.img_class == 'polyp':
                if "Domain1" in case:
