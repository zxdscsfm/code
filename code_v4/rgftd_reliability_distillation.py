...
def select_rdsi_teacher_logits(
    ...
    fg_from_boundary, fg_from_boundary_count = _add_reflow_action(
        fg_action_score,
        fg_proto_pre_mask,
        torch.where(fg_safe_for_min, boundary_budget_unused_pixels, torch.zeros_like(boundary_budget_unused_pixels)),
        occupied_mask,
    )
