#!/bin/bash
#SBATCH --job-name=FedLPPA_FAZ_PromptAggV1
...
LOG_DIR="logs/run_promptagg_v1_$(date +%Y%m%d_%H%M%S)"
mkdir -p "$LOG_DIR"
...
echo "Starting FedLPPA PromptAgg v1 experiment. Logs: $LOG_DIR"
...
wait
echo "PromptAgg v1 run finished."
