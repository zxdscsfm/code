#!/bin/bash
# Official FedLPPA + WANN + RGFTD-v2 on FAZ.
...
RUN_PREFIX="${RUN_PREFIX:-official_rgftd_v2_faz_paper_r500_l10}"
...
echo "Starting official FedLPPA + WANN + RGFTD-v2 FAZ run"
...
wait
echo "Official FedLPPA + WANN + RGFTD-v2 FAZ run finished. EXP_NAME=${EXP_NAME}"
