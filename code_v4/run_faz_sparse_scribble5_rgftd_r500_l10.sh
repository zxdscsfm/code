...
RUN_PREFIX="${RUN_PREFIX:-wann_rgftd_faz_sparse_scribble5_r500_l10}"
SERVER_ADDRESS="${SERVER_ADDRESS:-127.0.0.1:8535}"
SEED="${SEED:-2022}"
ITERS="${ITERS:-10}"
...
ROOT_PATH="${ROOT_PATH:-/data/jianbingshen/yanghongji/FedLPPA_Original/data/FAZ_h5}"
...
wait
echo "Official FedLPPA + WANN + RGFTD-v3.5 stable FAZ sparse5 run finished. EXP_NAME=${EXP_NAME}"
