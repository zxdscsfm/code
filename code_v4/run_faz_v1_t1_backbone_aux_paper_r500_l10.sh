...
# lighten auxiliary correction to reduce late-stage foreground expansion.

#SBATCH --job-name=FedLPPA_FAZ_V1_T1
...
METHOD_TAG="${METHOD_TAG:-v1_t1_faz_w1p_backbone_aux_paper_r500_l10}"
...
wait
echo "FAZ V1_T1 run finished. EXP_NAME=${EXP_NAME}"
