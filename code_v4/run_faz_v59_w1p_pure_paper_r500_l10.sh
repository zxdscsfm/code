#!/bin/bash
# FAZ W1':
# reuse the FAZ paper-aligned launcher, but switch to pure W1' from iteration 0 by parameters only.

#SBATCH --job-name=FedLPPA_FAZ_W1P
...
METHOD_TAG="${METHOD_TAG:-v59_faz_w1p_pure_paper_r500_l10}"
SERVER_ADDRESS="${SERVER_ADDRESS:-127.0.0.1:8189}"
SEED="${SEED:-2022}"
ITERS="${ITERS:-10}"
...
wait
echo "FAZ pure W1' run finished. EXP_NAME=${EXP_NAME}"
