...
#SBATCH --job-name=FedLPPA_ODOC_cleanV1
...
METHOD_TAG="${METHOD_TAG:-cleanV1_odoc_paper_r500_l10}"
SERVER_ADDRESS="${SERVER_ADDRESS:-127.0.0.1:8401}"
SEED="${SEED:-2022}"
ITERS="${ITERS:-10}"
...
echo "Starting ODOC cleanV1 run"
...
echo "ODOC cleanV1 run finished. EXP_NAME=${EXP_NAME}"
