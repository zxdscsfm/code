#!/bin/bash
# Official FedLPPA + WANN + RGFTD-v1 on ODOC.
...
RUN_PREFIX="${RUN_PREFIX:-official_rgftd_v1_odoc_paper_r500_l10}"
...
echo "Starting official FedLPPA + WANN + RGFTD-v1 ODOC run"
...
wait
echo "Official FedLPPA + WANN + RGFTD-v1 ODOC run finished. EXP_NAME=${EXP_NAME}"
