...
#SBATCH --job-name=FedLPPA_ODOC_SAR2
...
METHOD_TAG="${METHOD_TAG:-sar2_odoc_paper_r500_l10}"
SERVER_ADDRESS="${SERVER_ADDRESS:-127.0.0.1:8391}"
SEED="${SEED:-2022}"
ITERS="${ITERS:-10}"
...
echo "ODOC SAR2 run finished. EXP_NAME=${EXP_NAME}"
