...
#SBATCH --job-name=FedLPPA_ODOC_V1-DG2SAR
...
METHOD_TAG="${METHOD_TAG:-v1-dg2sar_odoc_paper_r500_l10}"
SERVER_ADDRESS="${SERVER_ADDRESS:-127.0.0.1:8379}"
SEED="${SEED:-2022}"
ITERS="${ITERS:-10}"
...
echo "Starting ODOC V1-DG2SAR run"
...
echo "ODOC V1-DG2SAR run finished. EXP_NAME=${EXP_NAME}"
