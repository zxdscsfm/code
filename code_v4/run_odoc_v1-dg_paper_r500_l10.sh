...
#SBATCH --job-name=FedLPPA_ODOC_V1-DG
...
METHOD_TAG="${METHOD_TAG:-v1-dg_odoc_paper_r500_l10}"
SERVER_ADDRESS="${SERVER_ADDRESS:-127.0.0.1:8378}"
SEED="${SEED:-2022}"
ITERS="${ITERS:-10}"
...
wait
echo "ODOC V1-DG run finished. EXP_NAME=${EXP_NAME}"
