...
#SBATCH --job-name=FedLPPA_ODOC_V1-SBONUS
...
METHOD_TAG="${METHOD_TAG:-v1-supportbonus_odoc_paper_r500_l10}"
SERVER_ADDRESS="${SERVER_ADDRESS:-127.0.0.1:8238}"
SEED="${SEED:-2022}"
ITERS="${ITERS:-10}"
...
echo "Starting ODOC V1-supportbonus run"
...
wait
echo "ODOC V1-supportbonus run finished. EXP_NAME=${EXP_NAME}"
