#!/bin/bash
# ODOC V1_T1:
# keep the original V1 mechanism and only make the first tuning pass:
# lighten auxiliary correction to reduce over-correction risk.

#SBATCH --job-name=FedLPPA_ODOC_V1_T1
...
METHOD_TAG="${METHOD_TAG:-v1_t1_odoc_w1p_backbone_aux_paper_r500_l10}"
...
--risk_calibration_global_soft_lambda 0.10 \
...
--risk_calibration_v1_aux_max_weight 0.20"

echo "Starting ODOC V1_T1 run"
...
wait
echo "ODOC V1_T1 run finished. EXP_NAME=${EXP_NAME}"
