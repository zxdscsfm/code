#!/bin/bash
# ODOC V1 uniform-geometry ablation:
...
#SBATCH --job-name=FedLPPA_ODOC_V1B
...
METHOD_TAG="${METHOD_TAG:-v1b_odoc_uniform_geom_ablation_paper_r500_l10}"
...
echo "Starting ODOC V1 uniform-geometry ablation run"
...
wait
echo "ODOC V1 uniform-geometry ablation run finished. EXP_NAME=${EXP_NAME}"
