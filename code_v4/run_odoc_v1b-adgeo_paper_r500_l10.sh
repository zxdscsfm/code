...
#SBATCH --job-name=FedLPPA_ODOC_V1B-adgeo
...
METHOD_TAG="${METHOD_TAG:-v1b-adgeo_odoc_paper_r500_l10}"
SERVER_ADDRESS="${SERVER_ADDRESS:-127.0.0.1:8207}"
SEED="${SEED:-2022}"
ITERS="${ITERS:-10}"
...
echo "Starting ODOC V1B adaptive-geometry run"
...
wait
echo "ODOC V1B adaptive-geometry run finished. EXP_NAME=${EXP_NAME}"
