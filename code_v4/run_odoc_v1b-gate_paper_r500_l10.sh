...
export METHOD_TAG="${METHOD_TAG:-v1b-gate_odoc_paper_r500_l10}"
export SERVER_ADDRESS="${SERVER_ADDRESS:-127.0.0.1:8207}"
...
bash /data/jianbingshen/yanghongji/FedLPPA/code_v4/run_odoc_v1_uniform_geom_ablation_paper_r500_l10.sh
