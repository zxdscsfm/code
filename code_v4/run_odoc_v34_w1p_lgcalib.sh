#!/bin/bash
# ODOC W1':
# geometry-guided pseudo-label weighting + local-global calibrated adaptive pseudo-labeling
# paper-aligned schedule: global 5000 / local 10

#SBATCH --job-name=FedLPPA_ODOC_W1P
...
METHOD_TAG="${METHOD_TAG:-v34_w1p_lgcalib_paper_r500_l10}"
...
echo "Starting ODOC W1' local-global calibrated adaptive PL run"
...
wait
echo "ODOC W1' local-global calibrated adaptive PL run finished. EXP_NAME=${EXP_NAME}"
