#!/bin/bash
# ODOC W1'':
# W1' local-global calibrated adaptive PL + per-client x per-bin x per-class adaptive tau
# paper-aligned schedule: global 5000 / local 10

#SBATCH --job-name=FedLPPA_ODOC_W1PP
...
METHOD_TAG="${METHOD_TAG:-v36_w1pp_classaware_paper_r500_l10}"
...
echo "Starting ODOC W1'' class-aware adaptive PL run"
...
wait
echo "ODOC W1'' class-aware adaptive PL run finished. EXP_NAME=${EXP_NAME}"
