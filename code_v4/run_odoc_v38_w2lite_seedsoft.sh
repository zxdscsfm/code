#!/bin/bash
# ODOC W2_lite:
# W1' gating + seed-support-assisted soft target refinement only
# paper-aligned schedule: global 5000 / local 10

#SBATCH --job-name=FedLPPA_ODOC_W2L
...
METHOD_TAG="${METHOD_TAG:-v38_w2lite_seedsoft_paper_r500_l10}"
...
echo "Starting ODOC W2_lite seed-support soft-refinement run"
...
wait
echo "ODOC W2_lite seed-support soft-refinement run finished. EXP_NAME=${EXP_NAME}"
