#!/bin/bash
# ODOC W3:
# W1' + client-risk-aware prior correction + stricter gating + global-anchor uncertainty decoupling
# paper-aligned schedule: global 5000 / local 10

#SBATCH --job-name=FedLPPA_ODOC_W3R
...
METHOD_TAG="${METHOD_TAG:-v39_w3_clientrisk_paper_r500_l10}"
...
echo "Starting ODOC W3 client-risk-aware adaptive PL run"
...
wait
echo "ODOC W3 client-risk-aware adaptive PL run finished. EXP_NAME=${EXP_NAME}"
