#!/bin/bash
# ODOC W6:
# W5' backbone + late weak-client soft-tail retention
# paper-aligned schedule: global 5000 / local 10

#SBATCH --job-name=FedLPPA_ODOC_W6
...
METHOD_TAG="${METHOD_TAG:-v52_w6_w5p_tail_paper_r500_l10}"
SERVER_ADDRESS="${SERVER_ADDRESS:-127.0.0.1:8179}"
SEED="${SEED:-2022}"
ITERS="${ITERS:-10}"
...
--risk_calibration_w6_late_tail_enabled 1 \
--risk_calibration_w6_tail_start_iter 2400 \
--risk_calibration_w6_tail_min_votes 2 \
--risk_calibration_w6_tail_risk_threshold 0.55 \
--risk_calibration_w6_tail_prior_gap_threshold 0.025 \
--risk_calibration_w6_tail_hard_ratio_threshold 0.50 \
--risk_calibration_w6_tail_peak_fraction 0.30 \
--risk_calibration_w6_tail_min_correction 0.03 \
--risk_calibration_w6_tail_risk_scale 0.12"

echo "Starting ODOC W6 run (W5' + late weak-client soft-tail retention)"
...
wait
echo "ODOC W6 run finished. EXP_NAME=${EXP_NAME}"
