#!/bin/bash
# ODOC W7:
# use W4.2-style early correction before 800, then hard-switch to pure W1' path.
# extended schedule: global 6000 / local 10

#SBATCH --job-name=FedLPPA_ODOC_W7R600
...
METHOD_TAG="${METHOD_TAG:-v56_w7_w42bootstrap_w1p_hardcut_paper_r600_l10}"
...
echo "Starting ODOC W7 run (W4.2-style bootstrap before 800, hard-switch to pure W1' after 800)"
...
wait
echo "ODOC W7 run finished. EXP_NAME=${EXP_NAME}"
