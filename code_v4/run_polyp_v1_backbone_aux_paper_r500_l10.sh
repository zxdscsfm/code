...
#SBATCH --job-name=FedLPPA_POLYP_V1
...
METHOD_TAG="${METHOD_TAG:-v1_polyp_w1p_backbone_aux_paper_r500_l10}"
SERVER_ADDRESS="${SERVER_ADDRESS:-127.0.0.1:8194}"
SEED="${SEED:-2022}"
ITERS="${ITERS:-10}"
...
wait
echo "POLYP V1 run finished. EXP_NAME=${EXP_NAME}"
