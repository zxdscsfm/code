...
CLIENT6_SUP_TYPE="${CLIENT6_SUP_TYPE:-box}"
WANN_PRED_START_ITER="${WANN_PRED_START_ITER:-4800}"
WANN_SOFT_RAMPUP_ITERS="${WANN_SOFT_RAMPUP_ITERS:-4800}"
WANN_CONS_RAMPUP_ITERS="${WANN_CONS_RAMPUP_ITERS:-4800}"
RGFTD_WARMUP_ITERS="${RGFTD_WARMUP_ITERS:-4800}"
RGFTD_RAMPUP_ITERS="${RGFTD_RAMPUP_ITERS:-4800}"
RGFTD_V3_AUDIT_START_ITERS="${RGFTD_V3_AUDIT_START_ITERS:-4800}"
