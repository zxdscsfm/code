#!/bin/bash
# Official FedLPPA + WANN + RGFTD-v1 on PROSTATE.
...
RUN_PREFIX="${RUN_PREFIX:-official_rgftd_v1_prostate_paper_r500_l10}"
...
echo "Starting official FedLPPA + WANN + RGFTD-v1 PROSTATE run"
...
wait
echo "Official FedLPPA + WANN + RGFTD-v1 PROSTATE run finished. EXP_NAME=${EXP_NAME}"
