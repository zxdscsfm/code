...
RUN_PREFIX="${RUN_PREFIX:-wann_rgftd_prostate_sparse_scribble5_r500_l10}"
...
ROOT_PATH="${ROOT_PATH:-/data/jianbingshen/yanghongji/FedLPPA_Original/data/PROSTATE_h5}"
CLIENT6_SUP_TYPE="${CLIENT6_SUP_TYPE:-sparse_scribble_5}"
...
echo "CLIENT6_SUP_TYPE=${CLIENT6_SUP_TYPE}"
...
python -u flower_pCE_2D_v4_FedLPPA.py ${BASE_ARGS} --role client --cid 0 --client client1 --sup_type sparse_scribble_5 --gpu 1 > "${LOG_DIR}/client0.log" 2>&1 &
python -u flower_pCE_2D_v4_FedLPPA.py ${BASE_ARGS} --role client --cid 1 --client client2 --sup_type sparse_scribble_5 --gpu 2 > "${LOG_DIR}/client1.log" 2>&1 &
python -u flower_pCE_2D_v4_FedLPPA.py ${BASE_ARGS} --role client --cid 2 --client client3 --sup_type sparse_scribble_5 --gpu 3 > "${LOG_DIR}/client2.log" 2>&1 &
python -u flower_pCE_2D_v4_FedLPPA.py ${BASE_ARGS} --role client --cid 3 --client client4 --sup_type sparse_scribble_5 --gpu 4 > "${LOG_DIR}/client3.log" 2>&1 &
python -u flower_pCE_2D_v4_FedLPPA.py ${BASE_ARGS} --role client --cid 4 --client client5 --sup_type sparse_scribble_5 --gpu 5 > "${LOG_DIR}/client4.log" 2>&1 &
python -u flower_pCE_2D_v4_FedLPPA.py ${BASE_ARGS} --role client --cid 5 --client client6 --sup_type "${CLIENT6_SUP_TYPE}" --gpu 6 > "${LOG_DIR}/client5.log" 2>&1 &
