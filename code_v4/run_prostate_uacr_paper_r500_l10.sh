...
#SBATCH --job-name=FedLPPA_PROSTATE_UACR
...
METHOD_TAG="${METHOD_TAG:-uacr_prostate_paper_r500_l10}"
...
echo "Starting PROSTATE UACR run"
...
echo "PROSTATE UACR run finished. EXP_NAME=${EXP_NAME}"
