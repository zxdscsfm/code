#!/bin/bash
# PROSTATE V1-DG2SAR:
# dg2 geometry branch + FedSAR semantic prototype branch + deterministic router.

#SBATCH --job-name=FedLPPA_PROSTATE_V1-DG2SAR
...
METHOD_TAG="${METHOD_TAG:-v1-dg2sar_prostate_paper_r500_l10}"
SERVER_ADDRESS="${SERVER_ADDRESS:-127.0.0.1:8389}"
SEED="${SEED:-2022}"
ITERS="${ITERS:-10}"
...
echo "Starting PROSTATE V1-DG2SAR run"
...
echo "PROSTATE V1-DG2SAR run finished. EXP_NAME=${EXP_NAME}"
