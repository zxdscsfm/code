#!/bin/bash
# PROSTATE V1B + adaptive geometry:
...
#SBATCH --job-name=FedLPPA_PROSTATE_V1B-adgeo
...
METHOD_TAG="${METHOD_TAG:-v1b-adgeo_prostate_paper_r500_l10}"
SERVER_ADDRESS="${SERVER_ADDRESS:-127.0.0.1:8208}"
SEED="${SEED:-2022}"
ITERS="${ITERS:-10}"
...
echo "Starting PROSTATE V1B adaptive-geometry run"
...
wait
echo "PROSTATE V1B adaptive-geometry run finished. EXP_NAME=${EXP_NAME}"
