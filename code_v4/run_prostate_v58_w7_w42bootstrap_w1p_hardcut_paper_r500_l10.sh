#!/bin/bash
# PROSTATE W7:
# transplant the W7 bootstrap-to-W1' hard-cut schedule onto PROSTATE under paper-aligned r500/l10.

#SBATCH --job-name=FedLPPA_PROSTATE_W7
...
METHOD_TAG="${METHOD_TAG:-v58_prostate_w7_w42bootstrap_w1p_hardcut_paper_r500_l10}"
SERVER_ADDRESS="${SERVER_ADDRESS:-127.0.0.1:8185}"
SEED="${SEED:-2022}"
ITERS="${ITERS:-10}"
...
wait
echo "PROSTATE W7 run finished. EXP_NAME=${EXP_NAME}"
