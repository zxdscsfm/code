...
class Trainer(object):
    ...
    def __init__(self, configer):
        ...
        self.train_tree_loss = AverageMeter()
    ...
    def _init_model(self):
        ...
        if is_distributed():
            ...
            self.tree_loss = self.module_runner.to_device(self.tree_loss)
        ...
        for i, data_dict in enumerate(self.train_loader):
            ...
            if is_distributed():
                ...
                with torch.cuda.amp.autocast():
                    ...
                    tree_loss = self.tree_loss(outputs[1], org_imgs, outputs[2], unlabeled_RoIs)
            ...
            display_tree_loss = tree_loss
            self.train_tree_loss.update(display_tree_loss.item(), batch_size)
            ...
            if self.configer.get('iters') % self.configer.get('solver', 'display_iter') == 0 and \
                ...
                Log.info('Train Epoch: {0}\tTrain Iteration: {1}\t'
                         ...
                         'Tree Energy Loss = {tree_loss.val:.5f} (ave = {tree_loss.avg:.5f})\n'.format(
                         ...
                         data_time=self.data_time, loss=self.train_losses, loss1=self.train_seg_loss, tree_loss=self.train_tree_loss))
