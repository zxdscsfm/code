...
class MyClient(BaseClient):
    ...
    def _move_batch_to_cuda(self, sampled_batch):
        ...
        elif self.args.img_class == 'odoc' or self.args.img_class == 'odoc_binary' or self.args.img_class == 'polyp' or self.args.img_class == 'isic' or self.args.img_class == 'busi' or self.args.img_class == 'tn3k':
...
# TreeEnergyLoss
        ...
        if self.args.img_class == 'odoc' or self.args.img_class == 'odoc_binary' or self.args.img_class == 'polyp' or self.args.img_class == 'isic' or self.args.img_class == 'busi' or self.args.img_class == 'tn3k':
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            if args.img_class == 'faz' or args.img_class == 'prostate':
                volume_batch, label_batch = sampled_batch['image'].unsqueeze(1), sampled_batch['label']
                volume_batch, label_batch = volume_batch.cuda(), label_batch.cuda()
            elif args.img_class == 'odoc' or args.img_class == 'odoc_binary' or args.img_class == 'polyp' or args.img_class == 'isic' or args.img_class == 'busi' or args.img_class == 'tn3k':
                volume_batch, label_batch = sampled_batch['image'], sampled_batch['label']
                volume_batch, label_batch = volume_batch.cuda(), label_batch.cuda()
            ...
            if iter_num % args.iters == 0:
                ...
                outputs = outputs[1, ...] * 50
                labs = label_batch[1, ...].unsqueeze(0) * 50
                if args.img_class == 'odoc' or args.img_class == 'odoc_binary' or args.img_class == 'polyp' or args.img_class == 'isic' or args.img_class == 'busi' or args.img_class == 'tn3k':
                    outputs, labs = outputs.repeat(3, 1, 1), labs.repeat(3, 1, 1)
...
def main():
    ...
    assert args.img_class in ['odoc', 'odoc_binary', 'faz', 'polyp', 'prostate', 'isic', 'busi', 'tn3k']
