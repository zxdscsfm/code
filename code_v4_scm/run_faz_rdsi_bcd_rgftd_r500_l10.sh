#!/bin/bash
# FedRAP-RDSI-BCD on FAZ with scribble-dominant heterogeneous weak labels.

#SBATCH --job-name=RDSIBCD_FAZ
...
RUN_PREFIX="${RUN_PREFIX:-rdsibcd_faz_r500_l10}"
...
echo "Starting FedRAP-RDSI-BCD FAZ run"
