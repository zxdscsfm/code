#!/bin/bash
# FedRAP-RDSI-TED on ODOC with scribble-dominant heterogeneous weak labels.

#SBATCH --job-name=RDSITED_ODOC
...
RUN_PREFIX="${RUN_PREFIX:-rdsited_odoc_r500_l10}"
...
ROOT_PATH="${ROOT_PATH:-/data/jianbingshen/yanghongji/FedLPPA_Original/data/ODOC_h5_rdsi3_sd}"
NUM_CLASSES="${NUM_CLASSES:-3}"
IMG_CLASS="${IMG_CLASS:-odoc}"
...
echo "Starting FedRAP-RDSI-TED ODOC run"
echo "EXP_NAME=${EXP_NAME}"
echo "LOG_DIR=${LOG_DIR}"
echo "SERVER_ADDRESS=${SERVER_ADDRESS}"
echo "ROOT_PATH=${ROOT_PATH}"
echo "NUM_CLASSES=${NUM_CLASSES}"
echo "IMG_CLASS=${IMG_CLASS}"
...
wait
echo "FedRAP-RDSI-TED ODOC run finished. EXP_NAME=${EXP_NAME}"
