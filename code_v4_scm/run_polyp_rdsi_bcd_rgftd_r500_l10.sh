#!/bin/bash
# FedRAP-RDSI-BCD on POLYP with scribble-dominant heterogeneous weak labels.

#SBATCH --job-name=RDSIBCD_POLY
...
RUN_PREFIX="${RUN_PREFIX:-rdsibcd_polyp_r500_l10}"
...
ROOT_PATH="${ROOT_PATH:-/data/jianbingshen/yanghongji/FedLPPA_Original/data/POLYP_h5_rdsi3_sd}"
...
--rgftd_v3_enabled 1 \
--rdsi_teacher_sup_types "${CLIENT1_SUP_TYPE},${CLIENT2_SUP_TYPE},${CLIENT3_SUP_TYPE},${CLIENT4_SUP_TYPE}" \
...
--rdsi_boundary_radius -1 \
--rdsi_boundary_uncertainty_width 0.25 \
--rdsi_core_damage_veto 0.30 \
--rdsi_unsafe_gap_scale 0.40 \
--rdsi_boundary_support_weight 0.35 \
--rdsi_core_preserving_fg_weight 0.25 \
--rdsi_teacher_reliability_weight 0.20 \
--rdsi_student_risk_weight 0.20 \
--rdsi_core_damage_weight 0.45 \
--rdsi_unsafe_gap_weight 0.30 \
--rdsi_foreground_excess_weight 0.25 \
--rdsi_knowledge_tiebreak_weight 0.00 \
--rdsi_safe_budget_gain 1.50 \
--rdsi_unsafe_budget_decay 1.00 \
--rdsi_max_budget_factor 4.00 \
--rdsi_core_reopen_boundary_floor 0.20 \
${EXTRA_ARGS}"

echo "Starting FedRAP-RDSI-BCD POLYP run"
echo "EXP_NAME=${EXP_NAME}"
echo "LOG_DIR=${LOG_DIR}"
echo "SERVER_ADDRESS=${SERVER_ADDRESS}"
echo "ROOT_PATH=${ROOT_PATH}"
echo "SUP_TYPES=${CLIENT1_SUP_TYPE},${CLIENT2_SUP_TYPE},${CLIENT3_SUP_TYPE},${CLIENT4_SUP_TYPE}"
