#!/bin/bash
# FedRAP-RDSI-BCD on PROSTATE with scribble-dominant heterogeneous weak labels.

#SBATCH --job-name=RDSIBCD_PROS
...
RUN_PREFIX="${RUN_PREFIX:-rdsibcd_prostate_r500_l10}"
...
echo "Starting FedRAP-RDSI-BCD PROSTATE run"
...
wait
echo "FedRAP-RDSI-SS PROSTATE run finished. EXP_NAME=${EXP_NAME}"
