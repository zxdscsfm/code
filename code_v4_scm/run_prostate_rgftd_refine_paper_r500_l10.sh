#!/bin/bash
# Official FedLPPA + WANN + full RGFTD with target-side soft refinement on PROSTATE.

#SBATCH --job-name=FedLPPA_PROSTATE_RGFTD_REF
...
export RUN_PREFIX="${RUN_PREFIX:-official_rgftd_refine_prostate_paper_r500_l10}"
...
exec "${SCRIPT_DIR}/run_prostate_rgftd_v33_paper_r500_l10.sh"
