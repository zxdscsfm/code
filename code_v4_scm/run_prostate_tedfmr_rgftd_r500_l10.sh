#!/bin/bash
# FedRAP-RDSI-SS on PROSTATE with scribble-dominant heterogeneous weak labels.

#SBATCH --job-name=TEDFMR_PROS
...
RUN_PREFIX="${RUN_PREFIX:-tedfmr_prostate_r500_l10}"
...
echo "Starting FedRAP-RDSI-SS PROSTATE run"
